...
public class JelloTargetHUD extends TargetHUD {
    ...
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        ...
        Color color = new Color(255, 255, 255, (int) (15 * alpha));
        ...
        RoundedUtil.drawRound(x + 39, (y + getHeight() - 8), 98, realHealthHeight, 1.5f, backgroundHealthColor);
        RoundedUtil.drawGradientHorizontal(x + 39, (y + getHeight() - 8), healthWidth, realHealthHeight, 1.5f, c1, c2);
