...
public class KeybindComponent extends SettingComponent<KeybindSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        float startY = y + tenacityFont16.getMiddleOfBox(height) - 6;
        ...
        tenacityFont16.drawCenteredString("Bind: §l" + bind, x + width /2f, y + tenacityFont16.getMiddleOfBox(height) - 6, textColor);
    }
