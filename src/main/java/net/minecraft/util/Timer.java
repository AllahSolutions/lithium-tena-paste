...
import dev.tenacity.module.impl.combat.TickRange;
...
public class Timer
{
    ...
    public void updateTimer() {
        ...
        if (Tenacity.INSTANCE.isEnabled(TickRange.class) && Minecraft.getMinecraft().inGameHasFocus && Minecraft.getMinecraft().theWorld != null && Minecraft.getMinecraft().thePlayer != null) {
            ...
            if (this.timeHelper.hasTimeElapsed(7000L) && Tenacity.INSTANCE.getModuleCollection().getModule(TickRange.class).balanceCounter < 250L) {
